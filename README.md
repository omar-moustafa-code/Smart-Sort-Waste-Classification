...
> *(Recommended: insert your pipeline diagram image here)*
...
└────────────┬────────────┘
             ...
             ▼
┌─────────────────────────┐
│  Stage 3: Recyclability │──► NON-RECYCLABLE → General waste bin (Code 7)
│  Classification         │
└────────────┬────────────┘
             │ Recyclable
             ▼
...
> *(Recommended: insert prototype image here)*
